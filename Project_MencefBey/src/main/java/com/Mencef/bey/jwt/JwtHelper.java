...
public class JwtHelper {
    ...
    public JwtHelper(@Value("${accessTokenSecret}") String accessTokenSecret, @Value("${refreshTokenSecret}") String refreshTokenSecret, @Value("${com.Mencef.bey.refreshTokenExpirationDays}") int refreshTokenExpirationDays, @Value("${com.Mencef.bey.accessTokenExpirationMinutes}") int accessTokenExpirationMinutes) {
